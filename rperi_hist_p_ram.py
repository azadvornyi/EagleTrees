...
# plt.hist(np.log10(p_ram), bins=30, color = 'grey')
#
# plt.ylabel('N')
# plt.xlabel(r'$p{ram} \ [(km/s)^2 M_{\star}^{2/3} cMpc^{-2}]$')
#
# plt.vlines(np.log10(percentile25), 0, 175, color='black')
#
# plt.vlines(np.log10(percentile50), 0, 175, color='black')
#
# plt.vlines(np.log10(percentile75), 0, 175, color='black')
# plt.title("P_ram  distribution")
# #plt.legend()
# #plt.savefig('Rperi_distribution.pdf',format='pdf')
# plt.savefig('plots_to_combine/p_ram_distribution.jpg',format='jpg',dpi=1200, pad_inches=0.1, bbox_inches='tight')
# plt.show()
# sys.exit()
...
plt.savefig('qtd_14_p_ram.pdf', format='pdf', dpi=1200, pad_inches=0.1, bbox_inches='tight')
#plt.savefig('plots_to_combine/qtd_14_p_ram.jpg', format='jpg', dpi=1200, pad_inches=0.1, bbox_inches='tight')
plt.show()
