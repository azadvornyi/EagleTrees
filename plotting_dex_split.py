...
plt.subplot(321)
plt.scatter(t_q[c]-t_i[c],t_i[c], s= 2, c= "blue", label = r"$9 < log_{10}(M_{\star}/M_{\odot})<11$")
...
plt.subplot(322)
plt.scatter(t_q[c9]-t_i[c9],t_i[c9], s= 2, c= "blue", label = r"$9 < log_{10}(M_{\star}/M_{\odot})<9.5$")
plt.ylabel(r"$\tau_q [Gyr]$")
plt.xlabel(r"$t_i \ [Gyr]$")
plt.ylim(-0.5, 14.2)
plt.xlim(-0.5, 14.2)
